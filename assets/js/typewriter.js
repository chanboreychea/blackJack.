var aText = new Array("Nothing lasts forever,", "We can change the future.");
// var aText = new Array(
...
function typewriter() {
  ...
  if (iTextPos++ == iArrLength) {
    ...
    if (iIndex != aText.length) {
      ...
      // Reset after completing the array
      iIndex = 0;
      setTimeout(typewriter, 5000); // 5 seconds delay before restarting
    }
  } else {
